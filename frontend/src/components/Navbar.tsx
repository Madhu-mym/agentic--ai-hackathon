  ...
  return (
    <header className="h-16 border-b border-slate-200/80 bg-white sticky top-0 z-40 px-4 sm:px-6 flex items-center justify-between">
      ...
      <div className="flex items-center space-x-6">
        ...
        {/* Desktop Quick Nav Links (for convenience) */}
        <nav className="hidden lg:flex items-center space-x-1 pl-4 border-l border-slate-200/80 text-xs font-medium">
          {navLinks.map((link) => {
      ...
      {/* Mobile Drawer Menu */}
      {mobileMenuOpen && (
        <div className="lg:hidden absolute top-16 left-0 right-0 bg-white border-b border-slate-200 shadow-lg p-4 space-y-2 z-50">
